...
class ControlTurtlesim():
	...
	linearX = input("Enter linear speed = ")
	    # Linear speed in x in units/second: positive values imply forward,
        # negative values == backwards
        move_cmd.linear.x = linearX	# Modify this value to change the Turtle's speed

        # Turn at 0 radians/s
	angularZ = input("Enter angular speed = ")
        move_cmd.angular.z = angularZ
